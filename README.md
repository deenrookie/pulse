...
```bash
# macOS (Apple Silicon)
curl -L https://github.com/deenrookie/pulse/releases/download/v0.3.5/pulse_0.3.5_darwin_arm64.tar.gz | tar xz && chmod +x pulse && ./pulse

# Linux (x64)
curl -L https://github.com/deenrookie/pulse/releases/download/v0.3.5/pulse_0.3.5_linux_amd64.tar.gz | tar xz && chmod +x pulse && ./pulse
```

```powershell
# Windows (x64) — PowerShell
curl.exe -L -o pulse.zip https://github.com/deenrookie/pulse/releases/download/v0.3.5/pulse_0.3.5_windows_amd64.zip
