...
import { indentWithTab, defaultKeymap, standardKeymap, history, historyKeymap } from '@codemirror/commands'
  ...
  useEffect(() => {
    ...
    const state = EditorState.create({
      ...
      extensions: [
        ...
        keymap.of([...historyKeymap, indentWithTab, ...defaultKeymap, ...standardKeymap]),
